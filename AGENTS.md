...
- Where a verified registry/credit designation supplies a canonical course host, distinguish that repository grade from the teaching year. Keep the full `source.grade_scope`, explain and cite the classification, and cross-link the shared record from all applicable grades. CLE's Grade 10 host and CLC's Grade 12 host do not prescribe delivery years. Do not duplicate standards for split-credit or language-reporting variants.
